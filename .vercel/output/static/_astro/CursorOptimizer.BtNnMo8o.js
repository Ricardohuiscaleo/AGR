import{r as b}from"./index.Bd8wGOW-.js";import{S as C,g as y}from"./ScrollTrigger.CUwdeFQJ.js";import"./_commonjsHelpers.D6-XlEtG.js";import"./index.c0qeY2gs.js";function k({showMarkers:c=!1}){const w=b.useRef(!1),p=b.useRef({}),n=(d,i,m="log",e=5e3)=>{if(!c)return;const r=Date.now();(!p.current[d]||r-p.current[d]>e)&&(console[m](`[CursorOptimizer] ${i}`),p.current[d]=r)};return b.useEffect(()=>{if(w.current)return;w.current=!0;const d=async()=>{if(y.registerPlugin(C),c){const e=document.createElement("style");e.textContent=`
