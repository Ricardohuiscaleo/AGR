...
export default function Galaxy({
  ...
  }), [focal, rotation, starSpeed, density, hueShift, speed, glowIntensity, saturation, mouseRepulsion, twinkleIntensity, rotationSpeed, repulsionStrength, autoCenterRepulsion, transparent]);
  ...
  useEffect(() => {
    ...
    try {
      ...
      const update = (t: number) => {
        if (!isVisible.current || disableAnimation) {
        ...
        try {
          ...
          console.warn('Galaxy render error:', error);
        }
  ...
  }, [uniforms, disableAnimation, mouseInteraction, handleMouseMove, handleMouseLeave, starSpeed, transparent]);

  return <div ref={ctnDom} className="galaxy-container" style={{ position: 'absolute', top: 0, left: 0, zIndex: -1 }} />;
}